...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.AlterField(
            ...
            name='rating',
            field=models.DecimalField(decimal_places=1, max_digits=2, validators=[django.core.validators.MinValueValidator(0, 'The rating must be between 0.0 and 10.0'), django.core.validators.MaxValueValidator(10, 'The rating must be between 0.0 and 100.0')]),
        ),
        migrations.AlterField(
            model_name='videogame',
            name='release_year',
